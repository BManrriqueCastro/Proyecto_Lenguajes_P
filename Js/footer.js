    ...
    <div class="footer">
        ...
        <div class="titulos">
            ...
            <div class="grid-item-3">
                <div class="conatiner_logo-contact">
        ...
        <div class="conteiner_general">
            <div class="container_lc1">
                <a href="index.html" class="link_container-lc1">
                    <img src="../imgs/icono_claro_1.png" alt="Logo de la pagina web" class="lc1">
                </a>
            </div>
            <div class="redes">
            ...
            <div class="contact">
                <form>
                    ...
                    <div class="form_input">
                        <label>Mensaje
                            <textarea placeholder="Dejá tu mensaje"></textarea>
                        </label>
                    </div>
                    <div class="form_input">
